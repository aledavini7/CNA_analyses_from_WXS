process CNVKIT_BATCH {
    ...
    awk -v sid='${sample_id}' 'BEGIN{FS=OFS="\t"} NR==1{for(i=1;i<=NF;i++) h[\$i]=i; next} \$1=="6" && \$2<133138703 && \$3>133135708 {print sid,\$1,\$2,\$3,\$h["log2"],(h["cn"] ? \$h["cn"] : "NA"),(h["probes"] ? \$h["probes"] : "NA")}' ${tumor_bam.simpleName}.call.cns > ${sample_id}.RPS12_6q.tsv
